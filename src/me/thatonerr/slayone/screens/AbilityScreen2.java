...
public class AbilityScreen2 extends UIScreen {

    private int currentPage = 1;
    private Character character;
    private List<UIScreen> pages;
    private List<UIAbilityMeter> abilityMeters;

    private Font mainFont = GameFont.SETTINGS_SUBCONTENT;

    private UIButton leftBtn, rightBtn;

    public AbilityScreen2(List<UIScreen> pages, List<UIAbilityMeter> abilityMeters, ScreenManager screenManager, Game game) {
